...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Numercial and Categorical Imputation, Scaling and Encoding Completed")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info(f"processing object: {type(preprocessing_obj)}")
            ...
            logging.info("Applying preprocessor object to training and testing dataframes")
            ...
            logging.info("Saving preprocessing object initiated")
